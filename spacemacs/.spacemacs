...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; A list of packages that will not be installed and loaded.
    dotspacemacs-excluded-packages '(flycheck-mix lsp-python-ms)
...
(defun my/insert-paren-start ()
  (interactive)
  (insert "\("))

(defun my/insert-paren-end ()
  (interactive)
  (insert "\)"))
...
before packages are loaded."
  ...
  ;; Practice using SPC-fs instead of `:w` for saving
  (define-key evil-normal-state-map ":" 'evil-goto-mark)
  (define-key evil-normal-state-map "`" 'evil-ex)

  ;; Optimize the visual-line paragraph grabbing usage pattern
  ...
  ;; (define-key evil-normal-state-map "V" 'evil-goto-mark)
